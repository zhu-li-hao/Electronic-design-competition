...
/*串口3*/
#define USART3_REC_LEN  			1024  		//定义最大接收字节数 1024
#define USART3_SEN_LEN  			600  		  //定义最大发送字节数 600
	  	
extern u8  USART3_RX_BUF[USART3_REC_LEN]; 	//接收缓冲,最大USART_REC_LEN个字节.末字节为换行符 
extern u8  USART3_TX_BUF[USART3_SEN_LEN]; 	//接收缓冲,最大USART_REC_LEN个字节.末字节为换行符
...
void usart1_init(u32 bound); //串口1和串口2都包含在里面，波特率都为115200
